...
///
/// Material Design 3 provides the option to add icons on the thumb of the [CustomSwitch].
/// If [ThemeData.useMaterial3] is set to true, users can use [CustomSwitch.thumbIcon]
/// to add optional Icons based on the different [MaterialState]s of the [CustomSwitch].
///
/// {@tool dartpad}
/// This example shows a toggleable [CustomSwitch]. When the thumb slides to the other
...
///
/// {@tool dartpad}
/// This example shows how to customize [CustomSwitch] using [MaterialStateProperty]
/// switch properties.
///
...
///
/// {@tool dartpad}
/// This example shows how to add icons on the thumb of the [CustomSwitch] using the
/// [CustomSwitch.thumbIcon] property.
///
...
class CustomSwitch extends StatelessWidget {
  ...
  /// [MaterialState] of the [CustomSwitch], providing a different [Color] when it is
  /// [MaterialState.disabled].
  ///
  /// ```dart
  /// Switch(
  ...
  /// The outline color of this [CustomSwitch]'s track.
  ///
  /// Resolved in the following states:
  ///  * [MaterialState.selected].
  ///  * [MaterialState.hovered].
  ...
  /// the [CustomSwitch] track has no outline by default.
  ...
  /// [MaterialState] of the [CustomSwitch], providing a different [Icon] when it is
  /// [MaterialState.disabled].
  ///
  /// ```dart
  /// Switch(
  ...
  /// then the [CustomSwitch] does not have any icons on the thumb.
